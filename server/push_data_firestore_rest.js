// Push data to Firestore via REST API (no firebase package needed)
// Run: node push_data_firestore_rest.js
...
const workshopData = [
  ...
  { id: "5", title: "Python for Data Science Bootcamp", desc: "3-day intensive bootcamp covering Python programming, data analysis with Pandas.", photo: "/photogallery/20230121_095905_017.jpg", date: "2025-12-10", category: "Programming" },
  { id: "6", title: "Civil Engineering Site Visits & Workshop", desc: "Field visits and practical sessions on construction management and modern building technologies.", photo: "/photogallery/20230120_100045_017.jpg", date: "2025-11-22", category: "Civil" },
  { id: "7", title: "Drone Technology & UAV Workshop", desc: "Comprehensive hands-on workshop covering drone assembly, flight mechanics, and applications.", photo: "/photogallery/bec-aero-club.jpg", date: "2025-10-05", category: "Aeronautical" },
  { id: "8", title: "Cyber Security & Ethical Hacking", desc: "Workshop on ethical hacking techniques, network security, and cybersecurity best practices.", photo: "/photogallery/WhatsApp%20Image%202024-05-28%20at%2008.23.08.jpeg", date: "2025-09-14", category: "Technology" }
];
...
const aeroclubData = [
  { id: "1", title: "BEC Aero Club Activities", desc: "Students and faculty engaging in aeronautical design and testing at the campus hangar.", photo: "/photogallery/bec-aero-club.jpg", date: "2024-05-20", category: "Event" },
  ...
  { id: "10", title: "Aviation Research Forum", desc: "Biannual forum on sustainable aviation and drone swarm tech.", photo: "/photogallery/bec-aero-club3.jpg", date: "2024-04-25", category: "Event" },
  { id: "11", title: "Hangar Facility Overview", desc: "Comprehensive walkthrough of on-campus aeronautical hangar and labs.", photo: "/photogallery/bec-aero-club1-1.jpg", date: "2024-04-22", category: "Event" },
  { id: "12", title: "Aeronautical Team Session", desc: "Collaborative project session for university aeronautical engineering teams.", photo: "/photogallery/bec-aero-club3-3.jpg", date: "2024-04-20", category: "Event" }
];

// Convert JS array to Firestore REST format
...
async function patchDoc(docId, items) {
    ...
    const req = https.request(options, (res) => {
      ...
      res.on('end', () => {
        if (res.statusCode >= 200 && res.statusCode < 300) {
          console.log(`✅ ${docId} pushed! (${res.statusCode})`);
          resolve(data);
        } else {
          console.error(`❌ ${docId} failed: ${res.statusCode} - ${data.substring(0, 200)}`);
          resolve(data);
        }
      });
    });
...
async function main() {
  console.log("Pushing all data to Firestore via REST API...\n");
  await patchDoc("selected-students-v2", studentsData);
  await patchDoc("workshop", workshopData);
  await patchDoc("sports", sportsData);
  await patchDoc("aeroclub", aeroclubData);
  console.log("\n✅✅ ALL DONE!");
  process.exit(0);
}
