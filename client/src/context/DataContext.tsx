...
export const DataProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  useEffect(() => {
    ...
    const unsubFaculties = setupListener('university-faculties', setFaculties, [
      ...
      { id: "24", name: "Mrs. Snigdharani Jena", role: "Assistant Professor", department: "MBA", image: "/facilities/STAFF/Snigdharani Jena (MBA).jpg", email: "snigdharani.mba@becbbsr.ac.in", tag: "Faculty" },
