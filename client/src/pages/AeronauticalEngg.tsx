          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-xs md:text-sm leading-relaxed text-slate-200">
                To be a center of excellence in aeronautical engineering education and research, producing globally competitive aeronautical engineers with high safety standards and technical capability.
              </p>
            </motion.div>
            ...
            >
              ...
              <ul className="text-xs leading-relaxed space-y-2.5 list-disc pl-4 text-slate-200">
                <li>To deliver high quality technical education in aerodynamics, propulsion systems, and aircraft structures.</li>
                <li>To motivate students towards research in drone technologies, computational fluid dynamics (CFD), and avionics.</li>
                <li>To collaborate with airline carriers, defense PSUs, and space laboratories to facilitate internships and career placements.</li>
              </ul>
            </motion.div>
          </div>
