      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-[24px] overflow-hidden max-w-[800px] w-full shadow-2xl relative flex flex-col md:flex-row group"
          >
            {/* Background Image Area (Left on Desktop, Top on Mobile) */}
            ...
            {/* Content Area */}
            <div className="md:w-1/2 bg-white/95 backdrop-blur-lg p-8 md:p-10 flex flex-col justify-center relative">
              <button
                onClick={handleClose}
              ...
              <div className="inline-flex items-center gap-2 mb-4">
                ...
                <span className="text-accent font-bold tracking-[0.2em] text-[10px] uppercase font-poppins">Session 2026-27</span>
              </div>
              ...
              <div className="flex flex-col gap-3 mb-8">
                <div className="px-4 py-2 bg-slate-50 border border-slate-100 rounded-xl flex items-center justify-between font-bold text-[11px] uppercase tracking-wider text-navy-900 shadow-sm">
