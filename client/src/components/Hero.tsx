      ...
      <section className="relative h-[85vh] w-full overflow-hidden bg-[#0F172A] font-inter">
        <AnimatePresence>
          ...
          >
            ...
            {/* Engineered Overlays */}
            <div className="absolute inset-0 bg-[#1E3A8A]/50 z-10 mix-blend-multiply" />
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0F172A]/30 to-[#0F172A]/90 z-10" />
            ...
            {slides.map((_, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === currentIndex ? "w-16 bg-accent" : "w-10 bg-white/20 hover:bg-white/40"
                )}
              />
            ))}
          </div>
